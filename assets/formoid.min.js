const Formoid = (function () {
  const API_URL = (location.protocol == 'https:' ? 'https:' : 'http:') + '//formoid.net/api/push'
  ...
  function $ajax (url, settings) {
    return new Promise(function (resolve, reject) {
      ...
      xhr.onerror = function () {
        let message = 'Failed to query the server. '
  ...
  Form.prototype.getCaptchaToken = function () {
    const recaptcha = this.__recaptcha__
    return new Promise(function (resolve, reject) {
...
const formComponents = document.querySelectorAll('[data-form-type="formoid"]')

formComponents.forEach(function (component) {
  let formData
  const form = component.tagName === 'FORM' ? component : component.querySelector('form')
  const alert = component.querySelector('[data-form-alert]')
  const title = component.getAttribute('data-form-title') ? component : component.querySelector('[data-form-title]')
  const submit = component.querySelector('[type="submit"]')
  const inputArr = component.querySelectorAll('[data-form-field]')
  const alertSuccess = alert.innerHTML
  ...
  form.addEventListener('submit', function (event) {
    ...
    function parseInput (input) {
      return new Promise(function (resolve, reject) {
        ...
        const name = input.getAttribute('data-form-field') || input.getAttribute('name')
